...
public class Tache extends Graphe_orienter_value {
	...
	void saisir()
	{
		...
		System.out.print("Ordonner vos tache dans l'ordre chronologique et prioritaire");
		
		
		int nombreArc=0;
		for(int i=1;i<nombreSommet;i++)
		{
			System.out.print("\nDonnez la duree de la tache "+i+" : ");
			int poid=myInput.nextInt();
			System.out.print("Donnez le nombre des sucesseures de la tache "+i+" : ");
